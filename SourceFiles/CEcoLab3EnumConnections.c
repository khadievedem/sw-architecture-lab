 ...
 *
 * <описание>
 *   Данный исходный код описывает реализацию интерфейсов CEcoLab3EnumConnections
 * </описание>
 *
 * <автор>
 ...
 *
 */
int16_t ECOCALLMETHOD CEcoLab3EnumConnections_QueryInterface(/* in */ struct IEcoEnumConnections* me, /* in */ const UGUID* riid, /* out */ void** ppv) {
 ...
 *
 */
uint32_t ECOCALLMETHOD CEcoLab3EnumConnections_AddRef(/* in */ struct IEcoEnumConnections* me) {
    CEcoLab3EnumConnections* pCMe = (CEcoLab3EnumConnections*)me;
 ...
 *
 */
uint32_t ECOCALLMETHOD CEcoLab3EnumConnections_Release(/* in */ struct IEcoEnumConnections* me) {
    CEcoLab3EnumConnections* pCMe = (CEcoLab3EnumConnections*)me;
    ...
    if ( pCMe->m_cRef == 0 ) {
        deleteCEcoLab3EnumConnections((IEcoEnumConnections*)pCMe);
        return 0;
    }
    return pCMe->m_cRef;
}
 ...
 *
 */
int16_t ECOCALLMETHOD CEcoLab3EnumConnections_Next(/* in */ struct IEcoEnumConnections* me, /* in */ uint32_t cConnections, /* out */ struct EcoConnectionData *rgcd, /* out */ uint32_t *pcFetched) {
    CEcoLab3EnumConnections* pCMe = (CEcoLab3EnumConnections*)me;
 ...
 *
 */
int16_t ECOCALLMETHOD CEcoLab3EnumConnections_Skip(/* in */ struct IEcoEnumConnections* me, /* in */ uint32_t cConnections) {
    CEcoLab3EnumConnections* pCMe = (CEcoLab3EnumConnections*)me;
    uint32_t count = 0;
 ...
 *
 */
int16_t ECOCALLMETHOD CEcoLab3EnumConnections_Reset(/* in */ struct IEcoEnumConnections* me) {
    CEcoLab3EnumConnections* pCMe = (CEcoLab3EnumConnections*)me;
 ...
 *
 */
int16_t ECOCALLMETHOD CEcoLab3EnumConnections_Clone(/* in */ struct IEcoEnumConnections* me, /* out */ struct IEcoEnumConnections **ppEnum) {
    CEcoLab3EnumConnections* pCMe = (CEcoLab3EnumConnections*)me;
...
IEcoEnumConnectionsVTbl g_x0000000200000000C000000000000046VTblECP = {
	CEcoLab3EnumConnections_QueryInterface,
    CEcoLab3EnumConnections_AddRef,
    CEcoLab3EnumConnections_Release,
    CEcoLab3EnumConnections_Next,
    CEcoLab3EnumConnections_Skip,
    CEcoLab3EnumConnections_Reset,
    CEcoLab3EnumConnections_Clone	
};
...
int16_t ECOCALLMETHOD createCEcoLab3EnumConnections(/* in */ IEcoUnknown* pIUnkSystem, /* in */ IEcoList1* pIList, /* out */ IEcoEnumConnections** ppIEnum) {
    CEcoLab3EnumConnections* pCMe = 0;
    IEcoSystem1* pISys = 0;
    ...
    pCMe = (CEcoLab3EnumConnections*)pIMem->pVTbl->Alloc(pIMem, sizeof(CEcoLab3EnumConnections));
...
void ECOCALLMETHOD deleteCEcoLab3EnumConnections(/* in */ IEcoEnumConnections* pIEnum) {
    CEcoLab3EnumConnections* pCMe = (CEcoLab3EnumConnections*)pIEnum;
    IEcoMemoryAllocator1* pIMem = 0;
    uint32_t indx = 0;
    EcoConnectionData* pCD = 0;
